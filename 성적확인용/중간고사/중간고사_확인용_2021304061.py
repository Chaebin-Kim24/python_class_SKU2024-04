...
def ciper_all(decoded_str):
    # 주석처리된 부분
    encoded_str = ""  
    p7_src_str = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
...
# 정답: p7_dst_str = "DEFGHIJKLMNOPQURSTUVWXYZABC"
...
print("longest palindromic string:", longest_palindrome(p9_my_str))
...
print(my_format_float(123.456789, 10, 2))
print(my_format_float(123.456789))