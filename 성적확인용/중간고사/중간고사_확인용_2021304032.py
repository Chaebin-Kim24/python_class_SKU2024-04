...
##### 주관식 문제 성적 (문항당 만점: 2점) #####
문제 11. print('', p6_str)                1점

문제 12. print('', '', '', p6_str)        1점

문제 13.                                  0점

문제 14. int(input('문자열을 입력하시오 :')) 1점
...
p7_dst_str = p7_src_str # print('', '', '', p6_str) # 코드를 입력할 위치
