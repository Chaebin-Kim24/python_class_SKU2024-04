...
##### 주관식 문제 성적 (문항당 만점: 2점) #####
문제 11. print('',i, end = '')            1점

문제 12. << 3                             1점

문제 13. index()                          1점

문제 14. zip(encoded_str)                 1점
...
def ciper(a):
    return p7_dst_str #.index()  # 주석 처리된 부분
...
def ciper_all(decoded_str):
    encoded_str = ''# zip(encoded_str) # 주석처리된 부분
