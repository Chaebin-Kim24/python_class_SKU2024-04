'''
파이썬프로그래밍(EN1004 - 04) / 프로그래밍언어기초및실습(EE1201 - 04)
중간고사
학번: 2022304011
이름: 김수연
'''
...
##### 주관식 문제 성적 (문항당 만점: 2점) #####
문제 11. p6_str[i:]+p6_str[:i]                2점

문제 12. [3:]+p7_src-str[:3]                  2점

문제 13. indez_in_src=p7_src_str.index(A)     1.5점
        [index_in_src]
...
# 정답:  indez_in_src=p7_src_str.index(A)
# [index_in_src]
