...
# 각자가 선물을 준 장부 딕셔너리, 장부에는 선물 받은 사람 이름과 선물 개수가 적혀있음
# 
# 준사람: mark , 받은 사람: michael
#     딕셔너리에 없음: mark
#        장부가 추가됨 {'michael': 1}
#     현재 딕셔너리: {'mark': {'michael': 1}}
# 
# 준사람: mark , 받은 사람: johnson
#     딕셔너리에 있음: mark {'michael': 1}
#        장부에 이름이 추가됨 {'michael': 1, 'johnson': 1}
#     현재 딕셔너리: {'mark': {'michael': 1, 'johnson': 1}}
# 
# 준사람: jim , 받은 사람: john
#     딕셔너리에 없음: jim
#        장부가 추가됨 {'john': 1}
#     현재 딕셔너리: {'mark': {'michael': 1, 'johnson': 1}, 'jim': {'john': 1}}
# 
# 준사람: john , 받은 사람: jim
#     딕셔너리에 없음: john
#        장부가 추가됨 {'jim': 1}
#     현재 딕셔너리: {'mark': {'michael': 1, 'johnson': 1}, 'jim': {'john': 1}, 'john': {'jim': 1}}
# 
# 준사람: jim , 받은 사람: john
#     딕셔너리에 있음: jim {'john': 1}
#        장부에 선물 하나 추가됨 {'john': 2}
#     현재 딕셔너리: {'mark': {'michael': 1, 'johnson': 1}, 'jim': {'john': 2}, 'john': {'jim': 1}}
# 
# 준사람: johnson , 받은 사람: mark
#     딕셔너리에 없음: johnson
#        장부가 추가됨 {'mark': 1}
#     현재 딕셔너리: {'mark': {'michael': 1, 'johnson': 1}, 'jim': {'john': 2}, 'john': {'jim': 1}, 'johnson': {'mark': 1}}
# 
# 준사람: mark , 받은 사람: jim
#     딕셔너리에 있음: mark {'michael': 1, 'johnson': 1}
#        장부에 이름이 추가됨 {'michael': 1, 'johnson': 1, 'jim': 1}
#     현재 딕셔너리: {'mark': {'michael': 1, 'johnson': 1, 'jim': 1}, 'jim': {'john': 2}, 'john': {'jim': 1}, 'johnson': {'mark': 1}}
...
# 각자가 선물을 준 총 개수 딕셔너리
# 
# 준사람: mark , 장부: {'michael': 1, 'johnson': 1, 'jim': 1}
#     계산된 항목: michael 1
#     계산된 항목: johnson 1
#     계산된 항목: jim 1
#        총합: 3
...
#     계산된 항목: john 2
#        총합: 2
#     현재 딕셔너리: {'mark': 3, 'jim': 2}
# 
# 준사람: john , 장부: {'jim': 1}
#     계산된 항목: jim 1
#        총합: 1
#     현재 딕셔너리: {'mark': 3, 'jim': 2, 'john': 1}
# 
# 준사람: johnson , 장부: {'mark': 1}
#     계산된 항목: mark 1
#        총합: 1
#     현재 딕셔너리: {'mark': 3, 'jim': 2, 'john': 1, 'johnson': 1}
...
#     항목 추가: johnson 1
#     항목 추가: jim 1
#     현재 딕셔너리: {'michael': 1, 'johnson': 1, 'jim': 1}
# 
# 준사람: jim , 장부: {'john': 2}
#     항목 추가: john 2
#     현재 딕셔너리: {'michael': 1, 'johnson': 1, 'jim': 1, 'john': 2}
# 
# 준사람: john , 장부: {'jim': 1}
#     항목 업데이트: jim 1
#     현재 딕셔너리: {'michael': 1, 'johnson': 1, 'jim': 2, 'john': 2}
# 
# 준사람: johnson , 장부: {'mark': 1}
#     항목 추가: mark 1
#     현재 딕셔너리: {'michael': 1, 'johnson': 1, 'jim': 2, 'john': 2, 'mark': 1}
...
#     선물 받을지 확인할 친구: john
#        주고받은 숫자가 같음
#        선물 받을 예정: 모두에게 준 선물의 총 수가 더 많음
#     선물 받을지 확인할 친구: johnson
#        준선물 개수: 1
#        받은 선물 개수: 1
#        주고받은 숫자가 같음
#        선물 받을 예정: 모두에게 준 선물의 총 수가 더 많음
#     선물 받을지 확인할 친구: michael
#        준선물 개수: 1
#        선물 받을 예정: 더 많이 줬었음
#     선물 받을지 확인할 친구: jim
#        준선물 개수: 1
#        선물 받을 예정: 더 많이 줬었음
# 현재까지 계산된 받을 선물 딕셔너리 {'mark': 4, 'john': 0, 'johnson': 0, 'michael': 0, 'jim': 0}
# 
# 현재 계산할 친구: john
#     선물 받을지 확인할 친구: mark
#        주고받은 숫자가 같음
#        선물 없음: 모두에게 준 선물의 총 수가 작거나 같음
#     선물 없음: 본인
#     선물 받을지 확인할 친구: johnson
#        주고받은 숫자가 같음
#        선물 없음: 모두에게 준 선물의 총 수가 작거나 같음
...
#        주고받은 숫자가 같음
#        선물 없음: 모두에게 준 선물의 총 수가 작거나 같음
# 현재까지 계산된 받을 선물 딕셔너리 {'mark': 4, 'john': 0, 'johnson': 2, 'michael': 0, 'jim': 0}
# 
# 현재 계산할 친구: michael
#     선물 받을지 확인할 친구: mark
#        받은 선물 개수: 1
...
#        선물 받을 예정: 모두에게 준 선물의 총 수가 더 많음
#     선물 없음: 본인
# 현재까지 계산된 받을 선물 딕셔너리 {'mark': 4, 'john': 0, 'johnson': 2, 'michael': 0, 'jim': 2}
